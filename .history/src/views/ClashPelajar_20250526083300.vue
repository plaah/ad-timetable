  ...
  <div class="bg-gray-100 min-h-screen">
    ...
    <main>
      ...
      >
        ...
        <h2 class="text-2xl font-bold drop-shadow-md">Pertindihan Pelajar</h2>
        ...
        <table class="w-full border border-black text-sm text-center bg-[#d0e7f7]">
          ...
          <tbody>
            <tr v-for="(student, index) in clashList" :key="index">
              ...
              <td class="border border-black px-2 py-1 text-left px-2 py-1">
                <ul class="list-disc list-inside">
                  <li v-for="(conflict, i) in student.conflicts" :key="i">
                    {{ conflict }}
                  </li>
                </ul>
              </td>
              <td class="border border-black px-2 py-1 font-semibold">{{ student.suggestions }}</td>
            </tr>
          </tbody>
        </table>
      </div>
