  ...
  <div class="bg-gray-100 min-h-screen">
    ...
    <main>
      ...
      >
        ...
        <p class="drop-shadow-md text-sm text-center px-2">
          (hanya untuk ruang di bangunan N28 & N28A)
        </p>
          ...
          <table class="w-full text-sm text-center bg-[#d0e7f7]">
            <thead>
              <tr>
                ...
                <th class="border border-black px-2 py-1">Tarikh</th>
              </tr>
            </thead>
            <tbody>
              <tr v-for="(time, i) in timeSlots" :key="i">
                <td v-if="i === 0" :rowspan="timeSlots.length" class="border border-black px-2 py-1">
                ...
                <td class="border border-black px-2 py-1">
                  <div class="flex flex-col items-start space-y-1">
                    <label class="inline-flex items-center">
                      ...
                      />
                      Minggu Kuliah<br />
                      <span class="text-xs ml-4">2025-03-16 ↔ 2025-06-28</span>
                    </label>
                    <label class="inline-flex items-center">
                      <input
                        type="radio"
                      ...
                      />
                      Minggu Semasa<br />
                      <span class="text-xs ml-4">2025-04-20 ↔ 2025-04-26</span>
                    </label>
                    <label class="inline-flex items-center">
                      <input
                        type="radio"
                      ...
                      <div class="flex gap-2 mt-1 ml-4">
                        <input v-model="userStart" type="date" class="border px-1 py-0.5 text-xs" />
