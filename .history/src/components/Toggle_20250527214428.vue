...
<template>
    <!-- header -->
    <header
        class="border-b-3 fixed top-0 left-0 z-2 w-full bg-gradient-to-br from-blue-100 via-blue-200 to-blue-300 text-black p-4 flex justify-between items-center"
    >
